...
function generateSvgPlaceholder(width, height, text, bgColor = '0ea5e9', textColor = 'ffffff') {
...
console.log('You may need to update image references in your code from .jpg to .svg'); 